...
WEIGHTS_FILE         = os.environ.get("ECON_WEIGHTS_FILE", os.path.join(SCRIPT_DIR, "econ_weights.json"))
BEST_WEIGHTS_FILE    = os.environ.get("ECON_BEST_FILE",    os.path.join(SCRIPT_DIR, "econ_best_weights.json"))
HISTORY_FILE         = os.environ.get("ECON_HISTORY_FILE", os.path.join(SCRIPT_DIR, "econ_history.json"))
